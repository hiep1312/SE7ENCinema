    ...
    public function run(): void
    {
        ...
        for ($date = $startWindow->copy(); $date->lte($endWindow); $date->addDay()) {
            foreach ($movies as $movie) {
                ...
                // Số suất chiếu/ngày theo độ hot của phim
                ...
                for ($i = 0; $i < $dailyShows; $i++) {
                    ...
                    // ✅ Kiểm tra trùng suất toàn rạp cho cùng phim
                    ...
                    if ($exists) {
                        // Nếu phim này đã chiếu ở khung giờ này (ở bất kỳ phòng nào) thì bỏ qua
                        $cursor->addMinutes(15);
                        continue;
                    }

                    // ✅ Random chọn phòng bất kỳ (thay vì chỉ A1)
                    $room = $rooms->random();
