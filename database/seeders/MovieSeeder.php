...
class MovieSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($data as $movie) {
            ...
            $movie = Movie::create(array_merge($movie, ['title' => mb_convert_case($movie['title'], MB_CASE_TITLE_SIMPLE, 'UTF-8'), 'poster' => $poster, 'price' => fake()->randomElement([30000, 40000, 50000]), 'status' => $movie['release_date']->isFuture() ? 'coming_soon' : 'showing']));
