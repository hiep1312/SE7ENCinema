...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('client/assets/css/fonts.css') }}" />
        ...
        <link rel="stylesheet" href="{{ asset('client/assets/css/owl.theme.default.css') }}" />
        <link rel="stylesheet" href="{{ asset('client/assets/css/dl-menu.css') }}" />
        ...
        <link rel="stylesheet" href="{{ asset('client/assets/css/venobox.css') }}" />
        <link rel="stylesheet" href="{{ asset('client/assets/js/plugin/rs_slider/layers.css') }}" />
        <link rel="stylesheet" href="{{ asset('client/assets/js/plugin/rs_slider/navigation.css') }}" />
        <link rel="stylesheet" href="{{ asset('client/assets/js/plugin/rs_slider/settings.css') }}" />
