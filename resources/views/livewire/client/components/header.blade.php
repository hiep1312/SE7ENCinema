                                    ...
                                    <li>
                                        <div class="prs_navi_slider_wraper">
                                            <div class="owl-carousel owl-theme">
                                                <div class="item">
                                                    <img src="{{ asset('client/assets/images/content/up1.jpg') }}"
                                                        alt="navi_img">
                                                </div>
                                                <div class="item">
                                                    <img src="{{ asset('client/assets/images/content/up2.jpg') }}"
                                                        alt="navi_img">
                                                </div>
                                                <div class="item">
                                                    <img src="{{ asset('client/assets/images/content/up3.jpg') }}"
                                                        alt="navi_img">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <ul class="lg-submenu prs_navi_video_wrapper">
                                    <li>
                                        <div class="prs_video_navi_img_main_wrapper">
                                            <img src="{{ asset('client/assets/images/content/vp1.jpg')}}"
                                                alt="video_img">
                                    ...
                                    <li>
                                        <div class="prs_video_navi_img_main_wrapper">
                                            <img src="{{ asset('client/assets/images/content/vp2.jpg')}}"
                                                alt="video_img">
                                            <div class="prs_video_navi_overlay_wrapper"> <a
                                                    class="test-popup-link button" rel='external'
                                                    href='https://www.youtube.com/embed/ryzOXAO0Ss0' title='title'><i
                                    ...
                                    <li>
                                        <div class="prs_video_navi_img_main_wrapper">
                                            <img src="{{ asset('client/assets/images/content/vp3.jpg')}}"
                                                alt="video_img">
                                            <div class="prs_video_navi_overlay_wrapper"> <a
                                                    class="test-popup-link button" rel='external'
                                                    href='https://www.youtube.com/embed/ryzOXAO0Ss0' title='title'><i
                                    ...
                                    <li>
                                        <div class="prs_video_navi_img_main_wrapper">
                                            <img src="{{ asset('client/assets/images/content/vp4.jpg')}}"
                                                alt="video_img">
                                            <div class="prs_video_navi_overlay_wrapper"> <a
                                                    class="test-popup-link button" rel='external'
                                                    href='https://www.youtube.com/embed/ryzOXAO0Ss0' title='title'><i
                                    ...
                                    <li>
                                        <div class="prs_video_navi_img_main_wrapper">
                                            <img src="{{ asset('client/assets/images/content/vp5.jpg')}}"
                                                alt="video_img">
                                            <div class="prs_video_navi_overlay_wrapper"> <a
                                                    class="test-popup-link button" rel='external'
                                                    href='https://www.youtube.com/embed/ryzOXAO0Ss0' title='title'><i
                                    ...
                                    <li class="hidden-sm">
                                        <div class="prs_video_navi_img_main_wrapper">
                                            <img src="{{ asset('client/assets/images/content/vp6.jpg')}}"
                                                alt="video_img">
                                            <div class="prs_video_navi_overlay_wrapper"> <a
                                                    class="test-popup-link button" rel='external'
                                                    href='https://www.youtube.com/embed/ryzOXAO0Ss0' title='title'><i
