        ...
        <div id="rev_slider_41_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.1">
            <ul>
                @forelse($banners as $index => $banner)
                    <!-- SLIDE -->
                    <li data-index="rs-{{ 145 + $index }}" data-transition="fade" data-slotamount="7" data-hideafterloop="0"
                        data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300"
                        data-rotate="0" data-saveperformance="off" data-title="{{ $banner->title }}"
                        ...
                        <div class="tp-caption FoodCarousel-CloseButton rev-btn tp-resizeme"
                             id="slide-{{ 145 + $index }}-layer-5"
                             data-x="441" data-y="110" data-width="['auto']" data-height="['auto']"
                             data-type="button"
                             data-actions='[{"event":"click","action":"stoplayer","layer":"slide-{{ 145 + $index }}-layer-3","delay":""},{"event":"click","action":"stoplayer","layer":"slide-{{ 145 + $index }}-layer-5","delay":""},{"event":"click","action":"startlayer","layer":"slide-{{ 145 + $index }}-layer-1","delay":""}]'
                             ...
                             style="z-index: {{ 7 + ($index * 3) }}; white-space: nowrap;border-color:transparent;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;">
                            <i class="fa-icon-remove"></i>
                        </div>
                        <!-- LAYER FOR LINK (if available) -->
                        @if($banner->link)
                            <a href="{{ $banner->link }}" class="tp-caption" style="z-index: {{ 8 + ($index * 3) }}; position: absolute; top: 0; left: 0; width: 100%; height: 100%;"
                               data-x="['center','center','center','center']" data-y="['middle','middle','middle','middle']"
                               data-width="['100%']" data-height="['100%']" data-type="text"
                               data-responsive_offset="on"
                ...
                @empty
                    <!-- Fallback slide nếu không có banner -->
                    <li data-index="rs-145" data-transition="fade" data-slotamount="7" data-hideafterloop="0"
                        data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="300"
                        data-rotate="0" data-saveperformance="off" data-title="No Banners Available"
                        data-param1="" data-param2="" data-param3="" data-param4="" data-param5=""
                        data-param6="" data-param7="" data-param8="" data-param9="" data-param10=""
                        data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="{{ asset('client/assets/images/header/01.png') }}" alt="No Banner"
                             data-bgposition="center center" data-bgfit="contain" data-bgrepeat="no-repeat"
                             class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
