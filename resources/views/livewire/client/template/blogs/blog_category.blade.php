									...
									<div class="hs_blog_box1_cont_main_wrapper">
										<div class="hs_blog_cont_heading_wrapper">
											...
											<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem
												quis bibendum auctor, nisi elit sequat ipsum, nec sagittis sem nibh id
												elit. Duis sed odio sit amet nibh vulputate cursus a sit amet the
								...
								<div class="hs_blog_box1_main_wrapper hs_blog_box2_main_wrapper">
									<div class="hs_blog_box1_img_wrapper">
										<div class="owl-carousel owl-theme">
											...
											<div class="item">
												<img src="{{ asset('client/assets/images/content/blog_category/b2.jpg')}}" alt="blog_img">
											</div>
											<div class="item">
												<img src="{{ asset('client/assets/images/content/blog_category/b3.jpg')}}" alt="blog_img">
											</div>
										</div>
									</div>
									<div class="hs_blog_box1_cont_main_wrapper">
								...
								<div class="hs_blog_box1_main_wrapper hs_blog_box2_main_wrapper">
									...
									<div class="hs_blog_box1_cont_main_wrapper">
										<div class="hs_blog_cont_heading_wrapper">
											...
											<h2>Simplicity is about subtracting the obvious and adding part area of the
												meaningful</h2>
											<p>Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem
												quis bibendum auctor, nisi elit sequat ipsum, nec sagittis sem nibh id
												elit. Duis sed odio sit amet nibh vulputate cursus a sit amet the
