...
@push('styles')
@vite('resources/css/privacyPolicy.css')
@endpush

@section('content')


<div class="scRender scPrivacyPolicy">
    <div class="privacy-policy">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="privacy-policy__title-heading" style="padding-top:20px;">
                            <ul>
        ...
        <!-- Main Content -->
        <div class="privacy-policy__content container">
            <div class="row">
                <!-- Sidebar -->
                <div class="col-lg-3 col-md-4 privacy-policy__sidebar">
                    <div class="privacy-policy__sidebar-menu">
                        <h3 class="privacy-policy__sidebar-title">Danh mục</h3>
                        <ul>
                            <li><a class="privacy-policy__sidebar-link" href="#section-intro">Giới thiệu chung</a></li>
                            <li><a class="privacy-policy__sidebar-link" href="#section-scope">Các loại dữ liệu cá nhân</a></li>
                            <li><a class="privacy-policy__sidebar-link" href="#section-collection">Thu thập dữ liệu khác</a></li>
                            <li><a class="privacy-policy__sidebar-link" href="#section-cookies">Chính sách Cookie</a></li>
                            <li><a class="privacy-policy__sidebar-link" href="#section-cctv">Hệ thống giám sát</a></li>
                            <li><a class="privacy-policy__sidebar-link" href="#section-children">Thu thập thông tin trẻ em</a></li>
                            <li><a class="privacy-policy__sidebar-link" href="#section-purpose">Mục đích xử lý</a></li>
                            <li><a class="privacy-policy__sidebar-link" href="#section-storage">Lưu giữ và bảo mật</a></li>
                            <li><a class="privacy-policy__sidebar-link" href="#section-rights">Quyền của khách hàng</a></li>
                            <li><a class="privacy-policy__sidebar-link" href="#section-sharing">Chia sẻ thông tin</a></li>
                            <li><a class="privacy-policy__sidebar-link" href="#section-contact">Thông tin liên hệ</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-9 col-md-8">
                    <div class="privacy-policy__main-content">
                        <h1 class="privacy-policy__title">Chính sách bảo mật thông tin</h1>

                        <!-- Introduction -->
                        <section id="section-intro" class="privacy-policy__section">
                            <h2 class="privacy-policy__section-title">Giới thiệu chung</h2>
                            <div class="privacy-policy__section-content">
                                ...
                                <div class="privacy-policy__company-info-box">
                                ...
                                <div class="privacy-policy__important-notice">
                        ...
                        <!-- Section 1 -->
                        <section id="section-scope" class="privacy-policy__section">
                            <h2 class="privacy-policy__section-title">I. THÔNG TIN CHÚNG TÔI THU THẬP</h2>
                            <div class="privacy-policy__section-content">
                                <p>SE7ENCinema thu thập các loại thông tin sau từ khách hàng:</p>

                                <div class="privacy-policy__data-categories">
                                    <div class="privacy-policy__data-category">
                        ...
                        <!-- Section 2 -->
                        <section id="section-collection" class="privacy-policy__section">
                            <h2 class="privacy-policy__section-title">II. CÁCH THỨC THU THẬP THÔNG TIN</h2>
                            <div class="privacy-policy__section-content">
                        ...
                        <!-- Section 3 -->
                        <section id="section-cookies" class="privacy-policy__section">
                            <h2 class="privacy-policy__section-title">III. SỬ DỤNG COOKIES VÀ CÔNG NGHỆ TƯƠNG TỰ</h2>
                            <div class="privacy-policy__section-content">
                        ...
                        <!-- Section 4 -->
                        <section id="section-cctv" class="privacy-policy__section">
                            <h2 class="privacy-policy__section-title">IV. HỆ THỐNG CAMERA AN NINH (CCTV)</h2>
                            <div class="privacy-policy__section-content">
                        ...
                        <!-- Section 5 -->
                        <section id="section-children" class="privacy-policy__section">
                            <h2 class="privacy-policy__section-title">V. BẢO VỆ THÔNG TIN TRẺ EM</h2>
                            <div class="privacy-policy__section-content">
                        ...
                        <!-- Section 6 -->
                        <section id="section-purpose" class="privacy-policy__section">
                            <h2 class="privacy-policy__section-title">VI. MỤC ĐÍCH SỬ DỤNG THÔNG TIN</h2>
                            <div class="privacy-policy__section-content">
                                <p>SE7ENCinema sử dụng thông tin cá nhân của bạn cho các mục đích sau:</p>

                                <div class="privacy-policy__purpose-categories">
                                    <div class="privacy-policy__purpose-category">
                        ...
                        <!-- Section 7 -->
                        <section id="section-storage" class="privacy-policy__section">
                            <h2 class="privacy-policy__section-title">VII. LƯU TRỮ VÀ BẢO MẬT THÔNG TIN</h2>
                            <div class="privacy-policy__section-content">
                                <h3 class="privacy-policy__subsection-title">7.1. Thời gian lưu trữ:</h3>
                                <ul>
                                ...
                                <h3 class="privacy-policy__subsection-title">7.2. Biện pháp bảo mật:</h3>
                                <ul>
                        ...
                        <!-- Section 8 -->
                        <section id="section-rights" class="privacy-policy__section">
                            <h2 class="privacy-policy__section-title">VIII. QUYỀN CỦA KHÁCH HÀNG</h2>
                            <div class="privacy-policy__section-content">
                                <p>Bạn có các quyền sau đối với thông tin cá nhân của mình:</p>

                                <div class="privacy-policy__rights-list">
                        ...
                        <!-- Section 9 -->
                        <section id="section-sharing" class="privacy-policy__section">
                            <h2 class="privacy-policy__section-title">IX. CHIA SẺ THÔNG TIN VỚI BÊN THỨ BA</h2>
                            <div class="privacy-policy__section-content">
                        ...
                        <!-- Section 10 -->
                        <section id="section-contact" class="privacy-policy__section">
                            <h2 class="privacy-policy__section-title">X. THÔNG TIN LIÊN HỆ</h2>
                            <div class="privacy-policy__section-content">
                                <div class="privacy-policy__contact-section">
                                    ...
                                    <div class="privacy-policy__contact-methods">
                                        <div class="privacy-policy__contact-item">
                        ...
                        <div class="privacy-policy__footer">
                            <div class="privacy-policy__footer-note">
