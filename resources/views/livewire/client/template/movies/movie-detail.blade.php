<div class="movie-detail-page">
    <div class="movie-container">
        ...
        <div class="tabs-section">
            <div class="tab-nav-moveek">
                <button class="tab-item @if($tab === 'movie_info') active @endif" wire:click="setTab('movie_info')">
                    Thông tin phim
                </button>
                <button class="tab-item @if($tab === 'showtimes') active @endif" wire:click="setTab('showtimes')">
                    Lịch chiếu
                </button>
                <button class="tab-item @if($tab === 'ratings') active @endif" wire:click="setTab('ratings')">
                    Đánh giá
                </button>
            </div>
    ...
    <div class="tab-content-moveek">
                @if($tab === 'movie_info')
                    ...
                    <div class="comments-section">
                        <h3 class="comments-title">Bình luận ({{ $comments->count() }})</h3>
