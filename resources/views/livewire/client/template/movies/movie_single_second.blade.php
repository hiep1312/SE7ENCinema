		...
		<div class="container">
			...
			<div class="st_slider_rating_right">
				<div class="st_slider_rating_btn prs_animate_btn1">
					<ul>
						<li data-animation="animated fadeInUp"><a href="#"
								...
								<div class="row">
									...
									<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
										<div class="st_md_ts_main_sec float_left">
											<img src="{{ asset('client/assets/images/content/md1.png')}}" alt="img">
									...
									<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
										<div class="st_md_ts_main_sec float_left">
											<img src="{{ asset('client/assets/images/content/md2.png')}}" alt="img">
									...
									<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
										<div class="st_md_ts_main_sec float_left">
											<img src="{{ asset('client/assets/images/content/md3.png')}}" alt="img">
								...
								<div class="prs_upcome_tabs_wrapper prs_upcome_tabs_wrapper_mss float_left">
									<ul class="nav nav-tabs" role="tablist">
										...
										<li role="presentation"><a href="#menu2" aria-controls="trand" role="tab"
												data-toggle="tab">Behind The Scenes</a>
										</li>
									</ul>
								</div>
							</div>
													...
													<div class="owl-carousel owl-theme">
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="{{ asset('client/assets/images/content/c1.jpg')}}" alt="img">
														...
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="{{ asset('client/assets/images/content/c2.jpg')}}" alt="img">
														...
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="{{ asset('client/assets/images/content/c3.jpg')}}" alt="img">
														...
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="{{ asset('client/assets/images/content/c4.jpg')}}" alt="img">
											...
											<div class="col-md-12">
												<div class="st_md_summ_client_slider float_left">
													...
													<div class="owl-carousel owl-theme">
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="{{ asset('client/assets/images/content/c5.jpg')}}" alt="img">
														...
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="{{ asset('client/assets/images/content/c6.jpg')}}" alt="img">
														...
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="{{ asset('client/assets/images/content/c7.jpg')}}" alt="img">
														...
														<div class="item">
															<div class="st_summ_slider_cont float_left">
																<img src="{{ asset('client/assets/images/content/c8.jpg')}}" alt="img">
										...
										<div class="row">
											<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
												<div class="prs_ms_scene_slider_img prs_ms_scene_slider_img22">
													...
													<div class="prs_ms_scene_img_overlay"> <a
															href="{{ asset('client/assets/images/content/movie_single/sc1.jpg')}}"
											...
											<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
												<div class="prs_ms_scene_slider_img prs_ms_scene_slider_img22">
													...
													<div class="prs_ms_scene_img_overlay"> <a
															href="{{ asset('client/assets/images/content/movie_single/sc2.jpg')}}"
															class="venobox info" data-title="PORTFOLIO TITTLE"
															data-gall="gall12"><i class="flaticon-tool"></i></a>
													</div>
												</div>
											...
											<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
												<div class="prs_ms_scene_slider_img prs_ms_scene_slider_img22">
													...
													<div class="prs_ms_scene_img_overlay"> <a
															href="{{ asset('client/assets/images/content/movie_single/sc3.jpg')}}"
															class="venobox info" data-title="PORTFOLIO TITTLE"
															data-gall="gall12"><i class="flaticon-tool"></i></a>
													</div>
												</div>
											...
											<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
												<div class="prs_ms_scene_slider_img prs_ms_scene_slider_img22">
													...
													<div class="prs_ms_scene_img_overlay"> <a
															href="{{ asset('client/assets/images/content/movie_single/sc4.jpg')}}"
															class="venobox info" data-title="PORTFOLIO TITTLE"
															data-gall="gall12"><i class="flaticon-tool"></i></a>
													</div>
												</div>
											...
											<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
												<div class="prs_ms_scene_slider_img prs_ms_scene_slider_img22">
													...
													<div class="prs_ms_scene_img_overlay"> <a
															href="{{ asset('client/assets/images/content/movie_single/sc5.jpg')}}"
															class="venobox info" data-title="PORTFOLIO TITTLE"
															data-gall="gall12"><i class="flaticon-tool"></i></a>
													</div>
												</div>
											...
											<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
												<div class="prs_ms_scene_slider_img prs_ms_scene_slider_img22">
													...
													<div class="prs_ms_scene_img_overlay"> <a
															href="{{ asset('client/assets/images/content/movie_single/sc6.jpg')}}"
															class="venobox info" data-title="PORTFOLIO TITTLE"
															data-gall="gall12"><i class="flaticon-tool"></i></a>
													</div>
												</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="st_ind_sidebar_md_textbox float_left">
									<p>Highest grossing movie in Mumbai in last 24 hours</p> <a href="#">Know Box Office
										Report</a>
								</div>
							</div>
							<div class="col-md-12">
							...
							<div class="col-md-12">
								<div class="st_ind_sidebar_advertiz st_ind_sidebar_advertiz_md float_left">
									<a href="#">
										<img src="{{ asset('client/assets/images/index_III/add.png')}}" alt="img">
									</a>
								</div>
							</div>
							<div class="col-md-12">
