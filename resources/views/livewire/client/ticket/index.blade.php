...
@assets
<script>
    function toggleSettings(settingsBtn) {
...
<div>
    ...
    <div class="control-buttons no-print">
        <button class="control-btn" onclick="window.print()" title="In vé">
            <i class="fas fa-print"></i>
        </button>
        <button class="control-btn settings-btn" onclick="toggleSettings(this)" title="Cài đặt vé" wire:ignore.self>
            <i class="fas fa-cog"></i>
        </button>
    </div>

    <div class="settings-overlay no-print" onclick="toggleSettings(document.querySelector('.settings-btn'))" id="settingsOverlay" wire:ignore.self></div>

    <div class="settings-panel no-print" id="settingsPanel" wire:ignore.self>
        ...
        <div class="ticket-main">
            ...
            <div class="customer-info">
                <div class="info-item">
                    ...
                    <span class="info-value">{{ session()->has('userName') ? session('userName')[0] : $booking->user->name }}</span>
                </div>
                <div class="info-item">
                    <i class="fas fa-clock"></i>
