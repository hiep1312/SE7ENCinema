                                        ...
                                        <div id="home" class="tab-pane active">
                                            <div class="st_calender_contant_main_wrapper float_left">
                                                <div class="st_calender_row_cont float_left">
                                                    ...
                                                    <div class="st_calender_asc">
                                                        ...
                                                        <div class="st_calen_asc_heart_cont">
                                                            ...
                                                            <ul style="list-style-type: none;">
                                                                <li>
                                                                    <img
                                                                        src="{{ asset('client/assets/images/content/fast-food.png') }}">
                                                                </li>
                                                                <li>
                                                                    <img
                                                                        src="{{ asset('client/assets/images/content/bill.png') }}">
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="st_movie_block">
                                                        <div class="st_calen_asc_tecket_time_select">
                                                            <ul>
                                                                {{-- Lặp qua suất chiếu của phim --}}
                                                                @foreach ($movie->showtimes as $showtime)
                                                                <li>
                                                                    <a href="#" type="button"
                                                                        wire:click.prevent="goToSelectSeats({{ $showtime->id }})">
                                                                        {{ $showtime->start_time->format('d/m/Y H:i') }}
                                                                    </a>
                                                                    {{-- <p>
                                                                        Còn {{ $showtime->room->activeSeats->count() - $showtime->booked_seats_count }} / {{ $showtime->room->activeSeats->count() }} ghế
                                                                    </p> --}}
                                                                </li>
                                                                @endforeach
                                                            </ul>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <div class="prs_mcc_left_side_wrapper">
                            ...
                            <div class="prs_mcc_event_title_wrapper">
                                <h2>Top Events</h2>
                                <img src="{{ asset('client/assets/images/content/movie_category/event_img.jpg') }}"
                                    alt="event_img">
