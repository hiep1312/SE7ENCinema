<nav class="navbar p-0 fixed-top d-flex flex-row">
  ...
  <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
    ...
    <ul class="navbar-nav w-100">
      <li class="nav-item w-100">
        <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search">
          <input type="text" class="form-control" placeholder="Tìm kiếm quản trị...">
        </form>
      </li>
    </ul>
    <ul class="navbar-nav navbar-nav-right">
      ...
      <li class="nav-item dropdown border-left">
        @livewire('admin.notification-admins.notification-adm')
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
          <div class="navbar-profile">
            <img class="img-xs rounded-circle" src="{{ asset('admin/assets/images/faces/face15.jpg') }}" alt="">
            <p class="mb-0 d-none d-sm-block navbar-profile-name">Admin Cinema</p>
            <i class="mdi mdi-menu-down d-none d-sm-block"></i>
          </div>
        </a>
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
          <h6 class="p-3 mb-0">Cài đặt</h6>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item preview-item">
            <div class="preview-thumbnail">
              <div class="preview-icon bg-dark rounded-circle">
            ...
            <div class="preview-item-content" onclick="window.open('{{ route('client.userInfo') }}', '_self')">
              <p class="preview-subject mb-1">Thông tin cá nhân</p>
            </div>
          </a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item preview-item">
            ...
            <button type="submit" form="logout" class="preview-item-content" style="background: none; border: none; color: #fff;">
...
<form method="POST" action="{{ route('logout') }}" id="logout" style="display: none;"></form>
