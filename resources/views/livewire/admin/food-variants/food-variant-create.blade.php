<div class="scRender">
    {{-- Thông báo lỗi/thành công tổng quát --}}
    ...
    {{-- Lỗi chung cho mảng generatedVariants (ví dụ: nếu mảng rỗng) --}}
                    ...
                    <div class="card-body bg-dark">
                        <form wire:submit.prevent="createVariant" enctype="multipart/form-data">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    ...
                                                                    @if (isset($variant['image']) && is_object($variant['image']))
                                                                        {{-- Hiển thị ảnh tạm thời nếu là file mới upload --}}
                                                                        <img src="{{ $variant['image']->temporaryUrl() }}"
                                                                            class="img-thumbnail mt-2"
                                                                            style="max-height: 100px;">
                                                                    @elseif(isset($variant['image_path']) && !is_object($variant['image_path']) && $variant['image_path'])
                                                                        {{-- Hiển thị ảnh cũ nếu đã tồn tại và không phải là đối tượng upload mới --}}
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                ...
                                <a href="{{ route('admin.food_variants.index') }}" class="btn btn-outline-danger">Hủy
                                    bỏ</a>
                            </div>
                        </form>
                    </div>
