<div>
    <div class="container-lg mb-4" wire:poll="realTimeVariantUpdate">
        ...
        <div class="d-flex justify-content-between align-items-center my-3">
            ...
            <div>
                <a href="{{ route('admin.foods_variants.edit',$variantItem->id) }}" class="btn btn-warning me-2">
                ...
                <div class="card text-white" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h6 class="card-title">Tổng số biến thể liên quan</h6>
                                <h3 class="mb-0">{{ $relatedVariants->total() ?? ($relatedVariants->count() ?? 0) }}
                                </h3>
                            ...
                            <div class="card-body bg-dark"
                                ...
                                <table class="table table-borderless text-light">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $variantItem->quantity_available }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong class="text-warning">Giá</strong></td>
                                        <td>{{ number_format($variantItem->price) }}đ</td>
                                    </tr>
                                    <tr>
                                        <td><strong class="text-warning">Giới hạn số lượng</strong></td>
                                        <td>{{ $variantItem->limit }}</td>
                                    </tr>
                                    <tr>
