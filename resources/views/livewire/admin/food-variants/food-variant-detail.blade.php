                ...
                <div class="row">
                            ...
                            <div class="card-body bg-dark"
                                ...
                                <table class="table table-borderless text-light">
                                    <tr>
                                        ...
                                        <td><strong class="text-light" style="font-size: 0.875rem !important;">
                    ...
                    <div class="col-md-4">
                        <div class="card bg-dark border-light">
                            ...
                            <div class="card-body bg-dark d-flex justify-content-center align-items-center"
                                style="border-radius: 0 0 var(--bs-card-inner-border-radius) var(--bs-card-inner-border-radius);">
                                <div class="overflow-hidden"
                                    style="width: 200px; aspect-ratio: 1 / 1; border-radius: 4px;">
                                        ...
                                        <tbody>
                                            @forelse ($foodOrderItems as $foodOrder)
                                                <tr wire:key="{{ $foodOrder->id }}">
                                                    ...
                                                    <td class="text-center"><strong class="badge bg-gradient text-light"
                                                            style="background: linear-gradient(to right, #642b73, #c6426e) !important;">
                                                            {{ $foodOrder->variant->FoodItem->name }}
                                                        </strong>
                                                    </td>
                                                    <td class="text-center">
                                                        {{ number_format($foodOrder->quantity, 0, ',', '.') }}
                                                    </td>
                                                    <td class="text-center">
                                                    ...
                                                    <td class="text-center">
                                                        <strong class="text-light">
                                                            {{ $foodOrder->booking?->user->name ?? 'N/A' }}
                                                        </strong>
                                                    </td>
                                                    <td class="text-center">
                                                        <span
                                                    ...
                                                    <td class="text-center">
                                                        @switch($foodOrder->booking->status)
                                                            ...
                                                            @case('expired')
                                                                <span class="badge bg-warning text-dark">Đã hết hạn xử
                                                                    lý</span>
                                                            @break
