<div>
    ...
    <div class="container-lg mb-4">
        <div class="d-flex justify-content-between align-items-center my-3">
            <h2 class="text-light">Chỉnh sửa biến thể </h2>
                            ...
                            <div class="row align-items-start">
                                <div class="col-md-3 mb-3">
                                    <div class="mt-1 overflow-auto position-relative" style="max-height: 230px;">
                                        <img src="{{ asset('storage/' . ($imageUrl ?? '404.webp')) }}"
                                ...
                                <div class="col-md-9">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="name" class="form-label text-light">Tên biến thể
                                                    *</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="foodItemId" class="form-label text-light">Chọn Sản
                                                    phẩm</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-4">
                                                <label for="quantityVariants" class="form-label text-light">Giới hạn
                                                    số
                                                    lượng</label>
                                ...
                                @if ($RelatedVariant)
                                    <div class="container">
                                        <div class="col-12">
                                            <div class="card bg-dark border-light">
                                                <div class="card-header bg-gradient text-light"
                                                    style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                                                    <h5><i class="fas fa-layer-group me-2"></i>Danh sách biến thể cùng
                                                        loại</h5>
                                                </div>
                                                <div class="card-body bg-dark"
                                                    ...
                                                    <div class="table-responsive">
                                                        <table
                                                            class="table table-dark table-striped table-hover text-light border">
                                                            <thead>
                                                                <tr>
                                                                    <th class="text-center text-light">Tên biến thể
                                                                    </th>
                                                                ...
                                                                @forelse ($RelatedVariant as $variant)
                                                                    <tr wire:key="{{ $variant->id }}">
                                                                        <td class="text-center"><strong
                                                                                class="text-light">{{ $variant->name }}</strong>
                                                                        </td>
                                                                        ...
                                                                        <td class="text-center">
                                                                            ...
                                                                            @else
                                                                                <span class="text-muted">Không có giới
                                                                                    hạn</span>
                                                                            @endif
                                                                        </td>
                                                                        <td class="text-center">
                                                                            @switch($variant->status)
                                                                                ...
                                                                                @case('hidden')
                                                                                    <span
                                                                                        class="badge bg-warning text-dark">Ẩn</span>
                                                                                @break
                                    ...
                                    <div class="d-flex justify-content-between px-4 mt-4 mb-4">
                                        ...
                                        <a href="{{ route('admin.foods_variants.index') }}"
