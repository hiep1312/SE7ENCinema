...
<div class="scRender">
    <div class="container-lg mb-4" @if (session()->missing('deleteExpired')) wire:poll="cleanupBookingsAndUpdateData"
        @endif>
        <!-- Header -->
                        ...
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <h3 class="mb-0" style="color: #ffefbe; text-shadow: 0 0 6px rgba(197, 169, 86, 0.8);">
                                    {{ number_format($booking->foodOrderItems->sum(fn($foodOrderItem) =>
                                    $foodOrderItem->price * $foodOrderItem->quantity), 0, '.', '.') }}đ
                                </h3>
                                <small>VNĐ</small>
                            </div>
                            <div class="align-self-center">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-dark">
                                        ...
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeTopMoviesPeriod('3_days')">3 ngày gần nhất</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeTopMoviesPeriod('7_days')">7 ngày gần nhất</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#"
                                        ...
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeTopMoviesPeriod('1_month')">1 tháng gần
                                                nhất</a></li>
                                        <li><a class="dropdown-item" href="#"
                                        ...
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeTopMoviesPeriod('1_year')">1 năm gần nhất</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeTopMoviesPeriod('2_years')">2 năm gần nhất</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-dark">
                                        ...
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeSeatsPeriod('3_days')">3 ngày gần nhất</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeSeatsPeriod('7_days')">7 ngày gần nhất</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeSeatsPeriod('30_days')">30 ngày gần nhất</a>
                                        </li>
                                        <li>
                                            <hr class="dropdown-divider">
                                        </li>
                                        ...
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeSeatsPeriod('1_month')">1 tháng gần nhất</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeSeatsPeriod('3_months')">3 tháng gần nhất</a>
                                        </li>
                                        <li>
                                            <hr class="dropdown-divider">
                                        </li>
                                        ...
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeSeatsPeriod('1_year')">1 năm gần nhất</a></li>
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeSeatsPeriod('2_years')">2 năm gần nhất</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div>
                                <div wire:ignore id="seatsChart" style="height: 400px;"></div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-dark">
                                        ...
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeFoodsPeriod('3_days')">3 ngày gần nhất</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeFoodsPeriod('7_days')">7 ngày gần nhất</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeFoodsPeriod('30_days')">30 ngày gần nhất</a>
                                        </li>
                                        <li>
                                            <hr class="dropdown-divider">
                                        </li>
                                        ...
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeFoodsPeriod('1_month')">1 tháng gần nhất</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeFoodsPeriod('3_months')">3 tháng gần nhất</a>
                                        </li>
                                        <li>
                                            <hr class="dropdown-divider">
                                        </li>
                                        ...
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeFoodsPeriod('1_year')">1 năm gần nhất</a></li>
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeFoodsPeriod('2_years')">2 năm gần nhất</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-6 col-lg-12">
                        <div class="bg-dark rounded-3 p-3">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-outline-purple btn-sm dropdown-toggle" type="button"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="fas fa-filter me-1"></i>
                                        @switch($seatsPeriod)
                                        @case('3_days')
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-dark">
                                        <li>
                                            <h6 class="dropdown-header text-purple">Ngày</h6>
                                        </li>
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeSeatsPeriod('3_days')">3 ngày gần nhất</a>
                                        </li>
                                        ...
                                        <li>
                                            <h6 class="dropdown-header text-purple">Tháng</h6>
                                        </li>
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeSeatsPeriod('1_month')">1 tháng gần nhất</a>
                                        </li>
                                        ...
                                        <li>
                                            <h6 class="dropdown-header text-purple">Năm</h6>
                                        </li>
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeSeatsPeriod('1_year')">1 năm gần nhất</a></li>
                                        <li><a class="dropdown-item" href="#"
                            ...
                            <div>
                                <div wire:ignore id="topMoviesAndRoomsChart" style="height: 400px;"></div>
                            </div>
                        </div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <small class="text-danger fw-bold d-block mt-1 ms-1">-
                                            {{ number_format($booking->promotionUsages->sum('discount_amount'), 0, '.',
                                            '.') }}đ
                                            KM</small>
                                        @endif
                                    </td>
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="movie-genre">
                                            ...
                                            {{ $showtimeBooking->movie->genres->take(3)->implode('name', ', ') ?: 'Không
                                            có thể loại' }}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="text-light text-wrap lh-base">{{
                                                    Str::limit($userBooking->address, 200, '...') }}</span>
                                                @else
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <small class="text-muted d-block mt-1" style="font-size: 12px">
                                                    Giới tính:
                                                    {{ $userBooking->gender === 'man' ? 'Nam' : ($userBooking->gender
                                                    === 'woman' ? 'Nữ' : 'Khác') }}
                                                </small>
                                            </td>
                                        </tr>
                                ...
                                <table class="table table-dark table-striped table-hover text-light">
                                    ...
                                    <tbody>
                                        ...
                                        <tr wire:key="food-order-{{ $foodOrder->id }}">
                                            ...
                                            <td class="text-center">
                                                <strong class="text-light">{{ $foodOrder->variant->foodItem->name
                                                    }}</strong>
                                            </td>
                                            <td class="text-muted text-center">
                                                <p class="text-wrap lh-base" style="margin-bottom: 0;">
                                                    {{ Str::limit($foodOrder->variant->foodItem->description ?: 'Không
                                                    có mô tả', 100, '...') }}
                                                </p>
                                            </td>
                                            <td>
                                                ...
                                                <ul class="food-attributes-list">
                                                    <li>
                                                        ...
                                                        <span class="attr-label">{{ $attributeValue->attribute->name
                                                            }}:</span>
                                                        <span class="attr-value" style="color: #a78bfa;">{{
                                            ...
                                            <td class="text-center text-warning fw-bold">
                                                {{ number_format($foodOrder->price * $foodOrder->quantity, 0, ',', '.')
                                                }}đ
                                            </td>
                                        </tr>
                                        @empty
                                ...
                                <table class="table table-dark table-striped table-hover text-light">
                                    ...
                                    <tbody>
                                        ...
                                        <tr wire:key="promotion-{{ $promotionUsage->id }}">
                                            ...
                                            <td class="text-center">
                                                <strong class="text-light">{{ $promotionUsage->promotion->title
                                                    }}</strong>
                                            </td>
                                            <td class="text-muted text-center">
                                                <p class="text-wrap lh-base" style="margin-bottom: 0;">
                                                    {{ Str::limit($promotionUsage->promotion->description ?: 'Không có
                                                    mô
                                                    tả', 100, '...') }}
                                                </p>
                                            </td>
                                            <td class="text-center text-warning fw-bold">
                                                {{ number_format($promotionUsage->promotion->discount_value, 0, ',',
                                                '.')
                                                }}{{ $promotionUsage->promotion->discount_type === 'percentage' ? '%' :
                                                'đ'
                                                }}
                                            </td>
                                            <td class="text-center text-warning fw-bold">
...
<script>
    ...
    Livewire.on('updateData',function([$revenueData,$topMovies ,$seatsData,$foodsData ,$topFoods ,$topMoviesAndRooms]){
        ...
        let optionsTopMoviesAndRoomsChart = {
            chart: {
                height: 400,
                type: 'bar',
                background: 'transparent',
        ...
        window.renderAllCharts= function() {
                if(Object.values(chartInstances).length > 0){                   
                    ...
                    chartInstances.topMoviesAndRoomsChart.updateOptions(optionsTopMoviesAndRoomsChart);
                    console.log();
                    
                }else{
                    if (document.querySelector('#revenueChart')) {
                    console.log(document.querySelector('#revenueChart'));
                    chartInstances.revenueChart = createScChart(document.querySelector('#revenueChart'),optionsRevenueChart);
                    }
                    if (document.querySelector('#moviesSummaryChart')) {
                    console.log(document.querySelector('#moviesSummaryChart'));
                    chartInstances.moviesSummaryChart = createScChart(document.querySelector('#moviesSummaryChart'),optionsMoviesSummaryChart);
                    }
                    if (document.querySelector('#seatsChart')) {
                    console.log(document.querySelector('#seatsChart'));
                    chartInstances.seatsChart = createScChart(document.querySelector('#seatsChart'), optionsSeatsChart);
                    }
                    if (document.querySelector('#foodsChart')) {
                    console.log(document.querySelector('#foodsChart'));
                    chartInstances.foodsChart = createScChart(document.querySelector('#foodsChart'),optionsFoodsChart);
                    }
                    if (document.querySelector('#topFoodsChart')) {
                    console.log(document.querySelector('#topFoodsChart'));
                    chartInstances.topFoodsChart = createScChart(document.querySelector('#topFoodsChart'), optionsTopFoodsChart);
                    }
                    if (document.querySelector('#topMoviesAndRoomsChart')) {
                    console.log(document.querySelector('#topMoviesAndRoomsChart'));
                    chartInstances.topMoviesAndRoomsChart = createScChart(document.querySelector('#topMoviesAndRoomsChart'), optionsTopMoviesAndRoomsChart);
                    }
                }
