            ...
            <div class="col-lg-3 col-md-6">
                <div class="card bg-warning text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h6 class="card-title">Số tiền giảm giá</h6>
                                <h3 class="mb-0">{{ number_format($booking->promotionUsage?->discount_amount ?? 0, 0, '.', '.') }}đ</h3>
                                <small>VNĐ</small>
                            </div>
                            <div class="align-self-center">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="dropdown" wire:ignore>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-dark">
                                        ...
                                        <li><a class="dropdown-item" href="#"
                                                wire:click.prevent="changeTopFoodsPeriod('1_year')">1 năm gần
                                                nhất</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <small class="text-danger fw-bold d-block mt-1 ms-1">-
                                            {{ number_format($booking->promotionUsage->discount_amount, 0, '.', '.') }}đ KM</small>
                                        @endif
                                    </td>
                                </tr>
                                <tr>
...
<script>
    globalThis.chartInstances = {};
        ...
        Livewire.on('updateData', function([$revenueData, $topMovies, $seatsData, $foodsData, $topFoods, $filterTexts]) {
            ...
            const foodLabels = topFoodsData.length > 0 ? topFoodsData.map(item => item.food_name || 'N/A') : [
                'Không có dữ liệu'
            ];
            const foodQuantities = topFoodsData.length > 0 ? topFoodsData.map(item => item.total_quantity || 0) : [
                0];
