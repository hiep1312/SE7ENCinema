                            ...
                            <div class="w-100">
                                <div class="search-section p-2">
                                    ...
                                    <div class="filter-controls">
                                        <button type="button" id="selectAll" class="control-btn">Chọn tất cả</button>
                                        <button type="button" id="deselectAll" class="control-btn">Bỏ chọn tất cả</button>
...
<script>
    ...
    const btnUnselectAll = document.getElementById('deselectAll');
    ...
    btnSelectAll.addEventListener('click', () => updateSelected(true));
    btnUnselectAll.addEventListener('click', () => updateSelected(false));
</script>
@endscript
