<div class="container mt-4">
    ...
    <form wire:submit.prevent="store" novalidate>
        <div class="mb-3">
            ...
            <input wire:model="title" type="text" class="form-control @error('title') is-invalid @enderror" id="title" placeholder="Nhập tên phim" autocomplete="off">
            @error('title')
        ...
        <div class="mb-3">
            ...
            <input wire:model="duration" type="number" class="form-control @error('duration') is-invalid @enderror" id="duration" min="1" placeholder="Thời lượng phim (phút)" autocomplete="off">
            @error('duration')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input wire:model="release_date" type="date" class="form-control @error('release_date') is-invalid @enderror" id="release_date">
            @error('release_date')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
