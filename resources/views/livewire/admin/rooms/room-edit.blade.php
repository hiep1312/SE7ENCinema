                ...
                <div class="card bg-dark">
                    ...
                    <div class="card-body bg-dark">
                        <form wire:submit.prevent="updateRoom">
                            ...
                            <div class="mb-3">
                                <label for="last_maintenance_date" class="form-label text-light">Ngày bảo trì lần
                                    cuối</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" wire:model="vipRows"
                                            class="form-control bg-dark text-light border-light @error('vipArr.*') is-invalid @enderror"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" wire:model="coupleRows"
                                            class="form-control bg-dark text-light border-light @error('coupleArr.*') is-invalid @enderror"
                                            placeholder="VD: J,K">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" wire:model="formattedPriceStandard"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" wire:model="formattedPriceVip"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" wire:model="formattedPriceCouple"
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <div>
                                            <input type="checkbox" wire:model="checkLonely" id="rule-lonely"> Cấm chỗ lẻ
                                            ví Dụ A1 , A3
                                        </div>
                                        <div>
                                            <input type="checkbox" wire:model="checkSole" id="rule-sole"> Cấm chọn ghế
                                            lẻ góc tường , ví dụ A1 trống -> chọn A2
                                        </div>
                                        <div>
                                            <input type="checkbox" wire:model="checkDiagonal" id="rule-diagonal"> Cấm
                                            chọn chéo A1 , B2
                                        </div>
                                    </div>
                                </div>
