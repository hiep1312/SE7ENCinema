                                ...
                                <tr wire:key="{{$food->id}}">
                                    ...
                                    <td>
                                        <div class="mt-1 overflow-auto d-block text-center" style="max-height: 100px; width: 100px;">
                                            <img src="{{ asset('storage/' . ($food->image ?? '404.webp')) }}" alt="Ảnh sản phẩm {{ $food->name }}" class="rounded" style="width: 100%; height: auto;">
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        @if($food->description)
                                            <span class="text-light text-wrap">{{ Str::limit($food->description, 30, '...') }}</span>
                                        @else
                                        ...
                                        @if($food->variants->count() > 0)
                                            <div class="showtime-info">
                                                ...
                                                <div class="movie-title mb-1">
                                                    <i class="fa-solid fa-burger-soda me-1 text-primary"></i>
                                                ...
                                                <span class="badge bg-success">
                                                    ...
                                                    {{ number_format($food->variants->min('price'), 0, '.', '.') }}đ - {{ number_format($food->variants->max('price'), 0, '.', '.') }}đ
                                                </span>
                                                ...
                                                <div class="time-until mt-1">
                                                    <small class="text-info">
                                                        ...
                                                        {{ $food->variants->sum('quantity_available') }} số lượng món ăn
                                                    </small>
                                                </div>
                                            </div>
                                        @else
