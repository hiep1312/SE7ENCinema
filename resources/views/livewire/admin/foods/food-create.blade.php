                            ...
                            <div class="card-body p-4">
                                ...
                                @if ($selectedAttributeId)
                                    ...
                                    @if ($selectedAttr && $selectedAttr->values->count() > 0)
                                        <div>
                                            <label class="form-label text-light-emphasis fw-semibold d-block mb-2">2.
                                                Chọn giá trị (có thể chọn nhiều)</label>

                                            <div class="d-flex flex-wrap gap-2">
                                                @foreach ($selectedAttr->values as $value)
                                                    <input type="checkbox" class="btn-check"
                                                        id="value-{{ $value->id }}" value="{{ $value->id }}"
                        ...
                        <div class="row mb-3 align-items-end">
                            ...
                            <div class="col-md-2 text-md-end">
                                @if ($editingIndex === null)
                                    <button type="button" wire:click="addAttribute" class="btn btn-success w-100">
                                ...
                                @foreach ($variantAttributes as $index => $attribute)
                                    <div
                                        ...
                                        <div class="btn-group my-2 my-md-0" role="group">
                                            ...
                                            <button type="button" wire:click="moveUp({{ $index }}, 'up')"
                                                class="btn btn-sm btn-outline-light"
                                                @if ($index == 0) disabled @endif
                                                title="Di chuyển lên">
                                                <i class="fas fa-arrow-up"></i>
                                            </button>
                                            <button type="button" wire:click="moveDown({{ $index }}, 'down')"
                                                class="btn btn-sm btn-outline-light"
                    ...
                    @elseif ($variantTab === 'variants')
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                <button type="button" wire:click="generateVariantsFromAttributes"
                                    class="btn btn-primary me-2" @if (empty($variantAttributes)) disabled @endif>
                                    <i class="fas fa-sync-alt me-1"></i> Tái tạo biến thể
                                </button>

                                <button type="button" wire:click="$set('variantCreateMode', 'manual')"
                                    class="btn btn-primary" @if (empty($variantAttributes)) disabled @endif>
                            ...
                            <div class="card bg-dark border-secondary mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        @foreach ($variantAttributes as $attr)
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <select wire:model="manualAttributeValues.{{ $attr['name'] }}"
                                    ...
                                    <div class="mt-3 d-flex justify-content-start gap-2">
                                        <button type="button" class="btn btn-success" wire:click="addManualVariant">
                        ...
                        @if (count($generatedVariants))
                            ...
                            <div class="d-flex justify-content-end mt-3">
                                <button type="button" wire:click="removeGeneratedVariant({{ $index }})"
...
@else
<p class="text-light-50">Vui lòng thêm thuộc tính ở tab "Quản lý thuộc tính" và nhấn "Tái tạo biến thể" để sinh ra các
    biến thể.</p>
@endif
@endif
</div>
