<div class="scRender container-lg mb-4 ">
    <div class="d-flex justify-content-between align-items-center my-3">
        <h2 class="text-light">Chỉnh sửa khuyến mãi</h2>
            ...
            <form wire:submit.prevent="save">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" wire:model="title" class="form-control bg-dark text-light border-light @error('title') is-invalid @enderror" placeholder="Nhập tiêu đề khuyến mãi">
                        @error('title') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-6">
                        <label class="form-label text-light">Mã khuyến mãi *</label>
                        <input type="text" wire:model="code" class="form-control bg-dark text-light border-light @error('code') is-invalid @enderror" placeholder="Nhập mã khuyến mãi" readonly>
                    ...
                    <div class="col-md-6">
                        ...
                        <select wire:model.live="discount_type" class="form-select bg-dark text-light border-light @error('discount_type') is-invalid @enderror" readonly disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="datetime-local" wire:model="start_date" class="form-control bg-dark text-light border-light @error('start_date') is-invalid @enderror" min="{{ now()->format('Y-m-d\TH:i') }}" readonly>
