...
<style>
    ...
    .sc-date-tabs .nav-link:hover { background: #34363c; }
    .sc-date-tabs .nav-link.active {
        background: #000;
        color: #fff;
        position: relative;
    }
    ...
    <div class="container-lg mb-4">
        ...
        <div class="card bg-dark" wire:poll.6s>
            ...
            <div class="card-body bg-dark">
                ...
                <div class="sc-date-sticky" style="position: sticky; top: 70px; z-index: 1000; background: #1f2125;">
                <ul class="nav sc-date-tabs px-2" role="tablist">
                ...
                <div class="sc-date-underline"></div>
