                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="input-group">
                            <input type="text" wire:model.live.debounce.300ms="search"
                                class="form-control bg-dark text-light" placeholder="Tìm kiếm suất chiếu...">
                            ...
                            <tr>
                                ...
                                <td style="max-width: 200px;">
                                    ...
                                    <div class="movie-genre" style="margin-bottom: 0; margin-top: 3px;">
                                        ...
                                        {{ $showtime->movie->genres->take(1)->implode('name', ', ') ?: 'Không có thể
                                        loại' }} • {{ $showtime->movie->duration }} phút
                                    </div>
                                </td>
