                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" id = "movie" value="{{ $movies->firstWhere('id', $movie_id)?->title ?? '' }}"
                                                class="form-control bg-dark text-light border-light @error('movie_id') is-invalid @enderror"
                                                placeholder="Chưa chọn phim chiếu" disabled>
                                            <button type="button" class="btn btn-outline-warning" data-bs-toggle="modal" data-bs-target="#frameSelectionData" wire:click="$set('modalType', 'movie')">Chọn</button>
                                        </div>
                                        @error("movie_id")
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local"
                                            ...
                                            readonly value="{{ date("Y-m-d\TH:i", strtotime("+ ". $movies->firstWhere('id', $movie_id)?->duration." minutes", strtotime($start_time)) ?: null) }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
