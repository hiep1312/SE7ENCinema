...
class FoodVariantCreate extends Component
{
    ...
    public function addAttribute()
    {
        ...
        // Chuyển tất cả giá trị về lowercase để so trùng không phân biệt hoa thường
    ...
    public function createVariant()
    {
        ...
        // Xử lý các biến thể cũ không có attribute value
        ...
        foreach ($existingVariants as $existingVariant) {
            ...
            if (!$hasAttributeValue) {
                $existingVariant->forceDelete(); // Xóa cứng
            }
        }

        //Lưu các biến thể mới như bình thường
        foreach ($this->generatedVariants as $variant) {
